...
import { d as dZ, E as E9, O as OY, K as KB, D as Dv, Z as ZJ } from "./_libs/hugeicons__core-free-icons.mjs";
import { u as useChatsStore } from "./_ssr/router-BUFDE6mC.mjs";
...
function ProfileScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-4 max-w-[520px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] divide-y divide-white/8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HugeiconsIcon, { icon: E9, size: 16, strokeWidth: 2 }), label: "Уведомления", onClick: () => toast("Уведомления включены. Настройки скоро появятся.") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HugeiconsIcon, { icon: Dv, size: 16, strokeWidth: 2 }), label: "Частые вопросы", onClick: () => toast("Ответы на частые вопросы: chatlogix.com/faq") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "glass-card rounded-[18px] p-4 flex items-center justify-center gap-2 text-[14px] font-medium text-[oklch(0.78_0.18_25)] hover:bg-white/8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HugeiconsIcon, { icon: ZJ, size: 16, strokeWidth: 2 }),
      " Открыть Telegram"
    ] })
  ] });
}

...
import { a as FeatureIconBadge } from "./_ssr/FeatureIcon-CJCYaFzD.mjs";
...
function ChatsScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-3 max-w-[520px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: chats.map((c) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4", children: [
        ...
        activeFeatures.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-white/8 flex items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/chat/$chatId", params: {
            chatId: c.id
          }, className: "ml-auto text-[11px] text-muted-foreground hover:text-foreground", children: "Все функции →" })
        ] })
      ] }, c.id);
    }) })
  ] });

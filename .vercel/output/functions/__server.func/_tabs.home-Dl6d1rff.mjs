...
function HomeScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-5 max-w-[520px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/me", className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Личные функции", right: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
        "Открыть ",

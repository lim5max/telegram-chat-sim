...
import { u as useChatsStore, F as FEATURE_META } from "./_ssr/router-Ka44_1ec.mjs";
import { C as ChatAvatar } from "./_ssr/ChatAvatar-9l8M9lFu.mjs";
import { I as ICON_GRADIENTS, a as FeatureIconBadge } from "./_ssr/FeatureIcon-BB_4l6zT.mjs";
import { t as Msr, w as U, x as jY, T as Tar, I as Iv, O as OY } from "./_libs/hugeicons__core-free-icons.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-5 max-w-[520px] mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/profile", className: "w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/15 transition active:scale-95", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HugeiconsIcon, { icon: Msr, size: 17, strokeWidth: 2, className: "text-foreground/80" }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/me", className: "block", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] divide-y divide-white/8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PersonalRow, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HugeiconsIcon, { icon: Tar, size: 16, strokeWidth: 2, color: "white" }), title: "Super-Summary", status: superSummaryOn ? `Включён · 09:00${summaryChannels.length > 0 ? ` · +${summaryChannels.length} ${summaryChannels.length === 1 ? "канал" : summaryChannels.length < 5 ? "канала" : "каналов"}` : ""}` : "Отключён", on: superSummaryOn, gradient: ICON_GRADIENTS.summary }),

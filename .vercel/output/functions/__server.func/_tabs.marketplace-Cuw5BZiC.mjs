...
import { b as Route$3, u as useChatsStore, F as FEATURE_META } from "./_ssr/router-PagneTqV.mjs";
import { C as ChatAvatar } from "./_ssr/ChatAvatar-9l8M9lFu.mjs";
import { I as ICON_GRADIENTS, F as FeatureIcon } from "./_ssr/FeatureIcon-BB_4l6zT.mjs";
import { P as PayOrCollectBanner } from "./_ssr/PayOrCollectBanner-oZ6wetaX.mjs";
import { N as Nn, a as dR, v as vL, b as Orr, E as EC, H as H$, M as ME, e as Oz, f as Tkr, g as vh, S as Sd, C as Cs, p as px, i as uv, D as Dq, s as sl, j as pkr, V as Vc, k as En, U as U6, l as vFr, m as Chr, n as U$, L as LFr, o as fa, W as Wy, q as Oo, r as O3, z as zz } from "./_libs/hugeicons__core-free-icons.mjs";
...
const FEATURE_DETAILS = {
  ...
  superPodcast: {
    items: [{
      icon: U6,
      title: "Личный подкаст",
      subtitle: "Голосовая выжимка из всех ваших чатов в ЛС бота"
    }, {
      icon: vFr,
      title: "Выбор голоса",
      subtitle: "Onyx (мужской) или Shimmer (женский)"
    }, {
      icon: Chr,
      title: "До 4 минут на выпуск",
      subtitle: "Компактный формат, удобно слушать на ходу"
      ...
      icon: En,
      title: "Приходит автоматически",
      subtitle: "Каждое утро сразу после Super-Summary"
    }],
  ...
  anonymous: {
    items: [{
      ...
      icon: Oz,
      title: "Лимит 3 в день на человека",
      subtitle: "Защита от злоупотреблений"
    }, {
      icon: Tkr,
      title: "Модерация",
  ...
  askBot: {
    items: [{
      icon: EC,
      title: "Упоминание @ChatLogixBot",
      subtitle: "Работает в любом чате — даже если бот не добавлен"
    }, {
      icon: dR,
      title: "Поиск по интернету",
      subtitle: "Свежие статьи и данные через Brave Search"
    }, {
      icon: H$,
      title: "Универсальный эксперт",
      subtitle: "Технические вопросы, разбор сообщений через reply"
    }],
  ...
  routine: {
    items: [{
      icon: dR,
      title: "Свежие новости и статьи",
      subtitle: "Бот находит по твоей теме в интернете и публикует со ссылками"
    }, {
      icon: vL,
      title: "По расписанию",
      subtitle: "Раз в день, в 3 дня или в неделю — в выбранное время"
    }, {
      icon: Orr,
      title: "Настройка за минуту",
      subtitle: "Опиши тему своими словами в ЛС бота"
    }],
...
const FEATURE_TARIFFS = {
  ...
  superPodcast: [{
    name: "Free",
    price: "Бесплатно",
    limit: "16 минут суммарно (~4 выпуска)"
  }, {
    name: "Pro",
    price: "$5.99/мес",
    limit: "ежедневные выпуски, выбор голоса"
...
const FEATURES = ["summary", "askBot", "routine", "voice", "podcast", "superPodcast", "kb", "antispam", "anonymous"];
const NEW_FEATURES = /* @__PURE__ */ new Set(["podcast", "kb", "askBot", "routine"]);
...
function FeatureDetailView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 pb-6 space-y-4 max-w-[520px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4", children: [
      ...
      status !== "active" && f.monetization !== "free" && f.audience !== "user" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PayOrCollectBanner, { variant: "full" }) })
    ] }),
...
function AudienceTag({
  ...
  if (audience === "both") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] px-1.5 py-0.5 rounded font-medium uppercase tracking-wider shrink-0", style: {
        background: "oklch(0.65 0.18 340 / 0.15)",
        color: "oklch(0.78 0.14 340)"
      }, children: "личный" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] px-1.5 py-0.5 rounded font-medium uppercase tracking-wider shrink-0", style: {

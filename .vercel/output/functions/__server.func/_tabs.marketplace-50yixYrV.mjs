...
import { b as Route$3, u as useChatsStore, F as FEATURE_META } from "./_ssr/router-Cx3ciUei.mjs";
...
const FEATURE_DETAILS = {
  ...
  voice: {
    items: [{
      ...
      subtitle: "LLM-проверка расшифровок перед публикацией"
    }],
  ...
  antispam: {
    items: [{
      ...
      subtitle: "LLM-детект обходов, транслита и лит-спика"
    }, {
      icon: Cs,
...
const FEATURE_TARIFFS = {
  ...
  antispam: [{
    ...
    name: "Pro",
    price: "$2.49/мес",
    limit: "LLM-фильтр, кастомная капча, отчёты"
  }]
};
const FILTERS = [{
  id: "all",

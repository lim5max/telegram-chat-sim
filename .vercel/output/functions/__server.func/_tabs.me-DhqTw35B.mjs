...
import { u as useChatsStore, s as superPodcast } from "./_ssr/router-BUFDE6mC.mjs";
...
import { g as ChevronDown, f as ChevronRight, h as Play } from "./_libs/lucide-react.mjs";
...
function ForMeScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-3 max-w-[520px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-muted-foreground -mt-1", children: "Персональные функции — не привязаны к конкретному чату." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] overflow-hidden", children: [
      ...
      expanded === "podcast" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 space-y-3 border-t border-white/5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: ["Onyx", "Shimmer"].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => isPaidSubscription ? toast(`Голос: ${v}`) : toast("Доступно с подпиской"), className: `text-[12px] px-3 py-1.5 rounded-lg transition ${v === "Onyx" ? "bg-white/15 text-white" : "bg-white/6 text-muted-foreground"}`, children: v }, v)) })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => toggle("anonymous"), className: "w-full p-4 flex items-center gap-3 active:bg-white/5 transition", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground truncate", children: anonChats.length > 0 ? `Доступно в ${anonChats.length} чатах · ${totalAnon}/3 сегодня` : "Нет доступных чатов" })
        ] }),
      ...
      expanded === "anonymous" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 space-y-3 border-t border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-muted-foreground", children: "Отправьте сообщение через бота — автор скрыт от всех. Лимит: 3 в день." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[12px]", children: [
          "Отправлено сегодня: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: totalAnon }),
          " / 3"
        ] }),
        ...
        anonChats.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-muted-foreground italic", children: "Включите «Анонимные сообщения» в каталоге функций." })
      ] })
    ] })
  ] });
}

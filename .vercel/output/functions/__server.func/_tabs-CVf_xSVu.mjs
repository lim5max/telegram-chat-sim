...
import { h as hU, c as c$, u as ub, T as Tar } from "./_libs/hugeicons__core-free-icons.mjs";
...
const tabs = [
  ...
  { to: "/marketplace", label: "Все навыки", icon: ub },
  { to: "/me", label: "Твои навыки", icon: Tar }
];
function BottomNav() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-0 left-0 right-0 z-40 backdrop-blur-xl bg-background/85 border-t border-white/10 pb-[env(safe-area-inset-bottom)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[520px] mx-auto grid grid-cols-4", children: tabs.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Link,
    {
      to: t.to,

...
import { u as useChatsStore, F as FEATURE_META } from "./_ssr/router-DwIrenfy.mjs";
import { C as ChatAvatar } from "./_ssr/ChatAvatar-9l8M9lFu.mjs";
import { I as ICON_GRADIENTS, a as FeatureIconBadge } from "./_ssr/FeatureIcon-CJCYaFzD.mjs";
import { r as U, t as jY, T as Tar, I as Iv, O as OY } from "./_libs/hugeicons__core-free-icons.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-5 max-w-[520px] mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2.5 py-1.5 rounded-xl bg-white/10 text-[11px] font-medium text-foreground/80", children: [
          "админ: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold", children: chats.filter((c) => c.isAdmin).length })
        ] })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/me", className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Для меня", right: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
        "Открыть ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Мои чаты", right: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/chats", className: "flex items-center gap-1", children: [
        "Все ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 12 })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: topChats.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/chat/$chatId", params: {
        chatId: c.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Новые функции", right: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/marketplace", className: "flex items-center gap-1", children: [
        "Все ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 12 })
      ] }) }),
...
function FeatureCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/marketplace", className: "glass-card rounded-2xl p-3 active:scale-[0.99] transition", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 text-[10px] text-gradient font-semibold", children: f.price })
  ] });
}
export {

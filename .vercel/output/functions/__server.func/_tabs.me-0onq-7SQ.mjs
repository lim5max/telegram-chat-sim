...
import { T as Toggle, S as SummaryStylePicker } from "./_ssr/SummaryStylePicker-CtOZun_4.mjs";
import { u as useChatsStore } from "./_ssr/router-BSP2kAIL.mjs";
import { p as parseChannelLink } from "./_ssr/channelLink-CssYHcFh.mjs";
import { T as Tar, I as Iv, M as ME } from "./_libs/hugeicons__core-free-icons.mjs";
import { I as ICON_GRADIENTS } from "./_ssr/FeatureIcon-BB_4l6zT.mjs";
import { H as HugeiconsIcon } from "./_libs/hugeicons__react.mjs";
import { a as ChevronDown, X, h as Plus, b as ChevronRight, i as Play } from "./_libs/lucide-react.mjs";
...
import "./_ssr/summaryStyleToast-B6XvHo0p.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-5 space-y-3 max-w-[520px] mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => toggle("summary"), className: "w-full p-4 flex items-center gap-3 active:bg-white/5 transition", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground truncate", children: superSummaryOn ? `Включён · 09:00${summaryChannels.length > 0 ? ` · +${summaryChannels.length} ${summaryChannels.length === 1 ? "канал" : summaryChannels.length < 5 ? "канала" : "каналов"}` : ""}` : "Отключён" })
        ] }),
      ...
      expanded === "summary" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 space-y-4 border-t border-white/5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryStylePicker, { value: superSummaryStyle, onChange: (id) => {
          setSuperSummaryStyle(id);
          toast.success("Стиль обновлён", {
            description: id === "custom" ? "Свой промпт активирован" : void 0
          });
        }, context: "super", isPro: true, onUpgrade: () => navigate({
          to: "/"
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: [
              "Открытые каналы ",
              summaryChannels.length > 0 && `(${summaryChannels.length})`
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "🔒 только открытые" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-muted-foreground -mt-0.5", children: "Добавьте каналы — бот вынесет из них главное в утреннюю сводку вместе с чатами." }),
          summaryChannels.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: summaryChannels.map((ch) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 rounded-xl bg-white/8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-semibold shrink-0", style: {
              background: ICON_GRADIENTS.summary
            }, children: ch.title.charAt(0).toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] font-medium truncate", children: ch.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground truncate", children: ch.handle })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
              removeSummaryChannel(ch.id);
              toast(`${ch.handle} убран из сводки`);
            }, className: "w-7 h-7 rounded-full flex items-center justify-center text-muted-foreground hover:text-white hover:bg-white/10 transition shrink-0", "aria-label": `Убрать ${ch.handle}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 15 }) })
          ] }, ch.id)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: channelInput, onChange: (e) => setChannelInput(e.target.value), onKeyDown: (e) => e.key === "Enter" && handleAddChannel(), placeholder: "https://t.me/durov или @durov", className: "flex-1 bg-white/8 rounded-xl px-3 py-2.5 text-[13px] outline-none placeholder:text-muted-foreground/60" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAddChannel, disabled: !channelInput.trim(), className: "w-10 h-10 rounded-xl flex items-center justify-center text-white shrink-0 disabled:opacity-40", style: {
              background: "var(--gradient-primary)"
            }, "aria-label": "Добавить канал", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 18 }) })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] overflow-hidden", children: [
      ...
      expanded === "podcast" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 space-y-3 border-t border-white/5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[12px] mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Использовано" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: isPaidSubscription ? `Подписка до ${superPodcastSubscription.expiresAt}` : `${16 - freeMinutesLeft} из 16 бесплатных мин` })
          ] }),
          !isPaidSubscription && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-white/8 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full rounded-full", style: {
            width: `${Math.max((16 - freeMinutesLeft) / 16 * 100, 2)}%`,
            background: freeMinutesLeft <= 4 ? "oklch(0.65 0.22 25)" : "var(--gradient-primary)"
          } }) })
        ] }),
        !isPaidSubscription && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => toast.success("Ссылка на оплату создана"), className: "w-full py-2.5 text-[13px] font-semibold rounded-xl gradient-primary text-white", children: "Перейти на Super Podcast · $5.99/мес" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] overflow-hidden", children: [
      ...
      expanded === "anonymous" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 space-y-3 border-t border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-muted-foreground", children: "Отправьте сообщение через бота — автор скрыт от всех. Лимит: 3 в день на человека." }),

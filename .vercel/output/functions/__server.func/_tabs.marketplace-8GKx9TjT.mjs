...
import { b as Route$3, u as useChatsStore, F as FEATURE_META } from "./_ssr/router-BL3E8elt.mjs";
import { C as ChatAvatar } from "./_ssr/ChatAvatar-9l8M9lFu.mjs";
import { I as ICON_GRADIENTS, F as FeatureIcon } from "./_ssr/FeatureIcon-DwuoPByi.mjs";
import { N as Nn, E as EC, V as Vc, a as dR, H as H$, M as ME, b as Oz, e as Tkr, v as vh, S as Sd, C as Cs, p as px, f as uv, D as Dq, s as sl, g as pkr, i as En, U as U6, j as vFr, k as Chr, l as U$, L as LFr, m as fa, W as Wy, n as Oo, o as O3, z as zz } from "./_libs/hugeicons__core-free-icons.mjs";
...
const FEATURE_DETAILS = {
  ...
  askBot: {
    items: [{
      ...
      subtitle: "Inline-кнопки: искать в сети или в базе знаний чата"
    }, {
      icon: dR,
...
const FEATURES = ["summary", "askBot", "voice", "podcast", "superPodcast", "kb", "antispam", "anonymous"];
const NEW_FEATURES = /* @__PURE__ */ new Set(["podcast", "kb", "askBot"]);

...
import { R as Route$7, u as useChatsStore } from "./router-BfskArbM.mjs";
      ...
      case "onboard-admin":
        pushBot({
          ...
          buttons: [{
            ...
            label: "🎤 Посмотреть расшифровку голосовых",
      ...
      case "onboard-user-enable":
        ...
        pushBot({
          ...
          buttons: [{
            ...
            label: "🎧 Посмотреть Super Podcast",
      ...
      case "onboard-user-show-podcast":
        pushBot({
          ...
          buttons: [{
            ...
            label: "🕵️ Посмотреть анонимные сообщения",
...
Участники пишут /search прямо в чате — бот ищет по истории и отвечает с ссылками на нужные сообщения.`,
            buttons: [{
              ...
              label: "🎭 Посмотреть анонимные сообщения",

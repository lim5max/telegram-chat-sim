...
import { v as parseRedirect, w as mergeHeaders, l as isRedirect, s as resolveManifestAssetLink, j as rootRouteId, x as getNormalizedURL, y as getOrigin, z as attachRouterServerSsrUtils, A as defineHandlerCallback, C as createSerializationAdapter, D as createRawStreamRPCPlugin, i as invariant, g as isNotFound, E as isResolvedRedirect, F as executeRewriteInput, G as defaultSerovalPlugins, H as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BfRdc5By.mjs");
...
const manifest = {
  "61e62139df78d204e6c89473e839e6da2f40cd3a4b0ed08efcc0454d575e944f": {
    functionName: "fetchRoutineDigest_createServerFn_handler",
    importer: () => import("./routineFetch-vYKtIRzA.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BSP2kAIL.mjs").then((n) => n.r),

...
import { u as useChatsStore, R as Route$7, S as SUMMARY_STYLES } from "./router-Ka44_1ec.mjs";
...
import { b as buildStyledSummaryButtons, a as buildStyledSummaryText } from "./summaryStyleToast-DZoYncQz.mjs";
...
Ты можешь персонализировать саммари: время отправки, периодичность, эмодзи и т.д. — в настройках бота. А стиль саммари можно поменять прямо здесь, кнопкой ниже.`,
        buttons: [{
          label: "🎨 Изменить стиль саммари",
          action: `summary-style-pick:${target.id}`
        }, {
...
Улучши тариф — и каждое утро буду присылать саммари твоего чата именно в этом тоне. Промпт сможешь менять когда захочешь.`,
        buttons: [{
          label: "⬆️ Улучшить тариф",
          action: `open-tariffs:${cid}`
        }, {
          label: "⚙️ Настроить саммари",
          action: "onboard-admin-settings"
        }, ...tellButtons(GROUP_TOUR, `group:${cid}`, null, `:${cid}`)]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky bottom-0 backdrop-blur-xl bg-background/70 border-t border-white/8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[640px] mx-auto px-2.5 py-2.5 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-white/8 rounded-3xl px-4 py-2.5 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: input, onChange: (e) => setInput(e.target.value), onKeyDown: (e) => e.key === "Enter" && sendInput(), placeholder: customPromptEditChatId ? "✨ Опиши свой стиль одной строкой…" : anonStep === "compose" && anonChatId ? `🎭 Анонимно в «${chats.find((c) => c.id === anonChatId)?.name}»…` : skillStep === "compose" ? "🪄 Опиши идею навыка своими словами…" : channelStep === "await-link" ? "📡 Ссылка на канал, напр. https://t.me/durov…" : routineStep === "prompt" ? "✏️ Что присылать в чат…" : routineStep === "time" ? "⏰ Время, напр. 09:00…" : "Сообщение", className: "flex-1 bg-transparent outline-none text-[14px]" }),

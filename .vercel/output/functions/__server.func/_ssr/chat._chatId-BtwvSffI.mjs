...
import { T as Toggle } from "./SummaryStylePicker-B_6Q7aaH.mjs";
import { a as Route$6, u as useChatsStore, F as FEATURE_META } from "./router-Ka44_1ec.mjs";
import { I as ICON_GRADIENTS, F as FeatureIcon } from "./FeatureIcon-BB_4l6zT.mjs";
import { F as FeatureSettings } from "./FeatureSettings-CYRwhbn5.mjs";
import { g as getChatReport } from "./analytics-dibEPvj9.mjs";
import "../_libs/vaul.mjs";
import { T as TrendingUp, b as ChevronRight, a as ChevronDown } from "../_libs/lucide-react.mjs";
...
import "./summaryStyleToast-DZoYncQz.mjs";
import "../_libs/zustand.mjs";
import "../_libs/zod.mjs";
import "./PayOrCollectBanner-G_NGfusm.mjs";
...
function ChatLayout() {
  const featureMatch = useMatch({
    from: "/chat/$chatId/feature/$featureKey",
    shouldThrow: false
  });
  const analyticsMatch = useMatch({
    from: "/chat/$chatId/analytics",
    shouldThrow: false
  });
  if (featureMatch || analyticsMatch) return /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChatDetails, {});
}
const ALL = ["summary", "voice", "podcast", "kb", "askBot", "routine", "antispam", "anonymous"];
function ChatDetails() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pb-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 space-y-4 max-w-[520px] mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnalyticsEntry, { chat, chatId }),
...
function AnalyticsEntry({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/chat/$chatId/analytics", params: {
    chatId
  }, className: "glass-card rounded-[18px] p-3.5 flex items-center gap-3 active:scale-[0.99] transition", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-2xl flex items-center justify-center shrink-0 text-[20px] gradient-primary", children: "📊" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold", children: "Отчёт за 2 недели" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-muted-foreground truncate", children: [
        r.periodLabel,
        " · ",
        r.engagement.activeShare,
        "% активных · вовлечённость, графики, токсичность"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 18, className: "text-muted-foreground shrink-0" })
  ] });
}

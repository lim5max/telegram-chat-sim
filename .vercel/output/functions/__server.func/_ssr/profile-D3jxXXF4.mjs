...
import { u as useChatsStore, F as FEATURE_META } from "./router-CSOYlsPT.mjs";
import { F as FeatureIcon } from "./FeatureIcon-DwuoPByi.mjs";
import { T as TopBar } from "./TopBar-C__rpgVq.mjs";
import { H as HugeiconsIcon } from "../_libs/hugeicons__react.mjs";
import { a as ChevronDown, C as CircleCheck, b as ChevronRight } from "../_libs/lucide-react.mjs";
...
function ProfileScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, { title: "Профиль", back: {
      to: "/home"
    } }),

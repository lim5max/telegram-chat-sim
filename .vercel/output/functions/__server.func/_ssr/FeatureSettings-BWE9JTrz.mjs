...
import { T as Toggle, S as SummaryStylePicker } from "./SummaryStylePicker-CtOZun_4.mjs";
import { u as useChatsStore, D as DEFAULT_SUMMARY_STYLE, S as SUMMARY_STYLES } from "./router-BSP2kAIL.mjs";
import { s as showPreviewInChatToast } from "./summaryStyleToast-B6XvHo0p.mjs";
import { C as CollectionStatusCard, P as PayOrCollectBanner } from "./PayOrCollectBanner-DZta5nTk.mjs";
  ...
  switch (fk) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
        ...
        vPlan !== "Ultra" && (() => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionStatusCard, { chatId: chat.id, feature: "voice", ctx }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(PayOrCollectBanner, { variant: "compact", collection: ctx })
          ] });
        })()
      ] }) });
    }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
          ...
          !cp?.status?.includes("Активна") && (() => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionStatusCard, { chatId: chat.id, feature: "podcast", ctx }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(PayOrCollectBanner, { variant: "compact", collection: ctx })
            ] });
          })()
        ] }),
    ...
    case "kb": {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Настройки" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Setting, { label: "Команда", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[12px]", children: "/faq запрос" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[12px] text-muted-foreground leading-relaxed", children: [
            "Введите ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground", children: "/faq" }),
    ...
    case "askBot": {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Как пользоваться" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Setting, { label: "Упоминание", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[12px]", children: "@ChatLogixBot вопрос" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-muted-foreground leading-relaxed", children: "Упомяните бота в чате — он спросит, где искать: в сети или в базе знаний чата (если включена). Если база знаний выключена — сразу ищет в сети." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-muted-foreground leading-relaxed", children: "Лимитов на чат нет. Антиспам — не более 1 запроса в минуту, 15 в час и 50 в день на одного пользователя." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-muted-foreground leading-relaxed", children: "Авто-включается при первом mention в чате. Отключить можно тогглом выше." })
      ] }) });
    }
    case "routine":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(RoutineSettings, { chat });
    case "antispam":
...
function SummarySettings({ chat }) {
  ...
  const pushPreviewToChat = (id) => {
    setTabMode("private");
    setPendingBroadcast(`summary-preview:${chat.id}:${id}`);
    navigate({ to: "/" });
  };
  const offerPreview = (id) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-card rounded-[20px] p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SummaryStylePicker,
      {
        value: summaryStyle,
        onChange: (id) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Setting, { label: "Расширенный вариант", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Toggle,
        {
          defaultOn: extended,
          onChange: (v) => {
            ...
            toast(v ? "Расширенный вариант включён" : "Расширенный вариант отключён", {
              description: v ? "Длиннее, с цитатами участников и ссылками на ключевые сообщения." : void 0
            });
          }
        }
      ) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
      ...
      chat.plan !== "Contributor" && (() => {
        const upgrade = chat.plan === "Nano" ? { name: "Standard", price: 2.49 } : chat.plan === "Standard" ? { name: "Full-on", price: 4.99 } : { name: "Contributor", price: 99.9 };
        const ctx = {
          chatId: chat.id,
          feature: "summary",
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionStatusCard, { chatId: chat.id, feature: "summary", ctx }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(PayOrCollectBanner, { variant: "compact", collection: ctx })
        ] });
      })()
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
      ...
      !isPro && (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionStatusCard, { chatId: chat.id, feature: "antispam", ctx }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(PayOrCollectBanner, { variant: "compact", collection: ctx })
        ] });
      })()
    ] }),
...
function RoutineSettings({ chat }) {
  ...
  const openWizard = () => {
    setTabMode("private");
    navigate({ to: "/", search: { startRoutineFor: chat.id } });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Как работает" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-muted-foreground leading-relaxed", children: "Бот по расписанию публикует в чат подборки из сети по твоей теме. Описываешь запрос своими словами — бот находит и присылает со ссылками на источники." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-muted-foreground leading-relaxed", children: "Бесплатно. До 2 рутин на чат." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-[20px] p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Рутины чата" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground", children: [
          routines.length,
          " из 2"
        ] })
      ] }),
      routines.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[13px] text-muted-foreground text-center py-4", children: [
        "Пока ни одной рутины.",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Создайте первую в ЛС бота — там пошаговый wizard."
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: routines.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/4 rounded-xl p-3 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[14px] font-semibold truncate", children: r.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: r.sources.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        r.lastRunAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground", children: [
          "Последний пост: ",
          r.lastRunAt
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: openWizard,
          className: "w-full py-2.5 text-[13px] font-semibold rounded-xl gradient-primary text-white",
          children: "+ Создать рутину в боте"
        }
      )
    ] })
  ] });

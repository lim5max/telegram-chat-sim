...
import { R as Route$7, u as useChatsStore } from "./router-Cx3ciUei.mjs";
...
const initialPrivate = [{
  ...
  buttons: [{
    label: "📊 Посмотреть, как улучшить чат",
    action: "onboard-admin"
  }, {
    label: "✨ Изучить персональные возможности",
    action: "onboard-user"
  }]
}];
...
Напиши анонимное сообщение. Никто не узнает автора 🤫`
  ...
  const handleChatPicked = (chatId) => {
    ...
    if (!target) return;
    const topicEmojis = ["💬", "💡", "📊", "🗂", "📍"];
    const topicLines = target.topics.map((t, i) => `${topicEmojis[i % topicEmojis.length]} ${t} (**${Math.floor(Math.random() * 40 + 8)} сообщений**)`).join("\n");
    pushBot({
...
Теперь можно добавить расшифровку голосовых — участники смогут читать вместо того, чтобы слушать.`,
            buttons: [{
              ...
              label: "🎤 Включить расшифровку аудио",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "backdrop-blur-xl bg-background/80 border-t border-white/8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[640px] mx-auto px-2.5 py-2 grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChatMenuBtn, { label: "✨ Персональные навыки", onClick: () => handleAction("user-settings") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChatMenuBtn, { label: "🛠 Настройки в чатах", onClick: () => navigate({
          to: "/chats"
        }) })
      ] })
    ] }) }),

...
const appCss = "/assets/styles-ymELhUfS.css";
...
const $$splitComponentImporter$a = () => import("./subscriptions-VxEcYeBf.mjs");
const Route$b = createFileRoute("/subscriptions")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./profile-C4w5b2Ln.mjs");
...
const $$splitComponentImporter$8 = () => import("../_tabs-CVf_xSVu.mjs");
const Route$8 = createFileRoute("/_tabs")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./index-v5iS_-De.mjs");
...
const chats = [
  ...
  },
  {
    ...
    name: "Дизайн-команда",
    emoji: "🎨",
    avatarColor: "linear-gradient(135deg, oklch(0.68 0.18 320), oklch(0.55 0.20 290))",
    avatarUrl: "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=80&h=80&fit=crop&crop=center",
    initial: "Д",
    used: 131,
    limit: 1e3,
    plan: "Full-on",
    planUntil: "29.05.2026",
    topics: ["Брендбук v2", "Найм миддл-дизайнера", "Дедлайн по лендингу"],
    newMembers: 27,
    activityDelta: "+31%",
    hashtag: "#design_team",
    voices: 14,
    voiceDuration: "112 мин",
    members: 34,
    isAdmin: true,
    summary: { active: true },
    voice: { active: true, plan: "Pro" },
    knowledgeBase: { active: true, quotaUsed: 23, quotaTotal: 100 },
    chatPodcast: { active: true, voice: "Shimmer", status: "Активна до 29.05.2026" },
    antispam: { active: true, deleted24h: 4, paid: true },
    anonymous: { active: false, allowMedia: false, sentToday: 0 },
    askBot: { active: true },
    routine: { active: false }
  }
...
const $$splitNotFoundComponentImporter$2 = () => import("./chat._chatId-CkaJZw_Z.mjs");
const $$splitComponentImporter$6 = () => import("./chat._chatId-BtwvSffI.mjs");
...
const $$splitComponentImporter$5 = () => import("../_tabs.me-BJy5FM11.mjs");
const Route$5 = createFileRoute("/_tabs/me")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$4 = () => import("../_tabs.marketplace-DaX2cRwr.mjs");
const Route$4 = createFileRoute("/_tabs/marketplace")({
...
const $$splitComponentImporter$3 = () => import("../_tabs.home-DJ7tcGec.mjs");
const Route$3 = createFileRoute("/_tabs/home")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("../_tabs.chats-DCi8zfWt.mjs");
const Route$2 = createFileRoute("/_tabs/chats")({
  head: () => ({
    meta: [{
...
const $$splitNotFoundComponentImporter$1 = () => import("./chat._chatId.analytics-CkaJZw_Z.mjs");
const $$splitComponentImporter$1 = () => import("./chat._chatId.analytics-CnzLELno.mjs");
const Route$1 = createFileRoute("/chat/$chatId/analytics")({
...
const $$splitComponentImporter = () => import("./chat._chatId.feature._featureKey-CuF4VQQv.mjs");
...
const SubscriptionsRoute = Route$b.update({
  id: "/subscriptions",
  path: "/subscriptions",
...
const TabsMeRoute = Route$5.update({
  id: "/me",
  path: "/me",
  getParentRoute: () => TabsRoute
});
const TabsMarketplaceRoute = Route$4.update({
  id: "/marketplace",
  path: "/marketplace",
  getParentRoute: () => TabsRoute
});
const TabsHomeRoute = Route$3.update({
  id: "/home",
  path: "/home",
  getParentRoute: () => TabsRoute
});
const TabsChatsRoute = Route$2.update({
  id: "/chats",
  path: "/chats",
  getParentRoute: () => TabsRoute
});
const ChatChatIdAnalyticsRoute = Route$1.update({
  id: "/analytics",
  path: "/analytics",

...
import { S as SUMMARY_STYLES, C as CUSTOM_STYLE_DAILY_LIMIT } from "./router-PagneTqV.mjs";
import { d as consumeCustomStyleAttempt, e as customStylePrompt, c as customStyleRemaining, f as showPaywallToast } from "./summaryStyleToast-CK-59nob.mjs";
import { j as Check, k as Eye, S as Sparkles, L as Lock } from "../_libs/lucide-react.mjs";
function Toggle({
  defaultOn = false,
  onChange
}) {

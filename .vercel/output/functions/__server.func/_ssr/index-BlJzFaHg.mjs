...
import { u as useChatsStore, R as Route$6, C as CUSTOM_STYLE_DAILY_LIMIT } from "./router-CG29-TTj.mjs";
...
import { b as buildStyledSummaryButtons, a as buildStyledSummaryText, c as customStyleRemaining, d as consumeCustomStyleAttempt } from "./summaryStyleToast-DtGUPPK3.mjs";
      ...
      case "onboard-admin-preview-kb":
        pushBot({
          ...
          buttons: [{
            ...
            label: "💬 Расскажи про поиск в сети",
            action: "onboard-admin-preview-askBot"
          }]
        });
        break;
      case "onboard-admin-preview-askBot":
        pushBot({
          ...
          buttons: [{
            ...
            label: "🔁 Расскажи про рутины чата",
            action: "onboard-admin-preview-routine"
          }]
        });
        break;
      ...
      case "onboard-user-show-podcast":
        pushBot({
          ...
          buttons: [{
            ...
            label: "🔁 Расскажи про Мою Рутину",
            action: "onboard-user-show-routine"
          }]
        });
        break;
...
Участники пишут /faq прямо в чате — бот ищет по истории и отвечает с ссылками на нужные сообщения.`,
            buttons: [{
              ...
              label: "💬 Расскажи про поиск в сети",
              action: `onboard-admin-show-askBot:${cid}`
            }]
          });
          break;
        }
...
Можно спросить и про сообщение в чате — просто ответь на него с упоминанием бота.`,
            buttons: [{
              ...
              label: "🔁 Расскажи про рутины чата",
              action: `onboard-admin-show-routine:${cid}`
            }]
          });
          break;
        }

...
const appCss = "/assets/styles-r1eUdyDB.css";
...
const $$splitComponentImporter$9 = () => import("./subscriptions-DwyrcPoj.mjs");
...
const $$splitComponentImporter$8 = () => import("../_tabs-BkOTAjiS.mjs");
const Route$8 = createFileRoute("/_tabs")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./index-D9yr_-b4.mjs");
...
const $$splitComponentImporter$6 = () => import("./chat._chatId-mR-xhPOk.mjs");
...
const $$splitComponentImporter$5 = () => import("../_tabs.profile-BKLK7ZQl.mjs");
...
const $$splitComponentImporter$4 = () => import("../_tabs.me-DhqTw35B.mjs");
const Route$4 = createFileRoute("/_tabs/me")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Личные функции ChatLogix: Super-Summary, Super Podcast, анонимные сообщения."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_tabs.marketplace-Yozi0LpM.mjs");
const Route$3 = createFileRoute("/_tabs/marketplace")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Все функции ChatLogix: добавляй в чаты или подключай лично."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_tabs.home-Dl6d1rff.mjs");
const Route$2 = createFileRoute("/_tabs/home")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Дашборд ChatLogix: чаты, функции, новости."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_tabs.chats-DJu4QrFa.mjs");
const Route$1 = createFileRoute("/_tabs/chats")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Все ваши чаты с активными функциями ChatLogix."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitNotFoundComponentImporter = () => import("./chat._chatId.feature._featureKey-uWsSEQSq.mjs");
const $$splitComponentImporter = () => import("./chat._chatId.feature._featureKey-Bs7NLum4.mjs");
